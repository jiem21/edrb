...
<script>
	...
	$generate_label = pg_query($db->con,"SELECT distinct occur_month, DATE_PART('year',occur_date) occur_year FROM tbl_drb_tracking_ledger WHERE occur_date between '$FY1' AND '$FY2' ORDER BY occur_year ASC");
	$generate_label2 = pg_query($db->con,"SELECT distinct occur_month, DATE_PART('year',occur_date) occur_year FROM tbl_drb_tracking_ledger WHERE occur_date between '$FY1' AND '$FY2' ORDER BY occur_year ASC");
	...
	var DRB_BY_BLOCK = {
		...
		while ($blocks = pg_fetch_array($generate_block)) {
			...
			$generate_month = pg_query($db->con,"SELECT distinct DATE_PART('year',occur_date) ,occur_month FROM tbl_drb_tracking_ledger WHERE occur_date between '$FY1' AND '$FY2' ORDER BY DATE_PART('year',occur_date) ASC");
			?>
	...
	$generate_label3 = pg_query($db->con,"SELECT distinct occur_month, DATE_PART('year',occur_date) occur_year FROM tbl_drb_tracking_ledger WHERE occur_date between '$FY1' AND '$FY2' ORDER BY occur_year ASC");

	$generate_label4 = pg_query($db->con,"SELECT distinct occur_month, DATE_PART('year',occur_date) occur_year FROM tbl_drb_tracking_ledger WHERE occur_date between '$FY1' AND '$FY2' ORDER BY occur_year ASC");
	?>
